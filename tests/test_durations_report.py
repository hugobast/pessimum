...
class TestDurationsReport(TestCase):
    ...
    def run_with_duration(self, duration, a_test=Mock(Test)):
    ...
    def test_with_many_runs(self):
        self.run_with_duration(0.02, Mock(Test))
        self.run_with_duration(0.01, Mock(Test))
        self.run_with_duration(0.03, Mock(Test))
